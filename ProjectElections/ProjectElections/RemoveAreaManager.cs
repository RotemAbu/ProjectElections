...
{
    public partial class RemoveAreaManager : Form
    {
        private Voter voter;
        ...
        private void RemoveAreaManager_Load(object sender, EventArgs e)
        {
        ...
        private void nbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("The Area Manager not exist in the system");
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //If succeeded manager call removeAreaManager method and remove him from Voter_T DB. 
            try
            {
                int flag = electionsManager.removeAreaManager(IDtextBox.Text); //flag-for returning a result.

                if (flag == 1)
                {
                    MessageBox.Show("Removing Area Manager is succeeded!");
                }
                else
                {
                    MessageBox.Show("Removing Area Manager is failed!");
                }
            }
            catch (Exception e1)
            {
